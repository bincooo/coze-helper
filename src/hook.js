...
opn = Object.getOwnPropertyNames
Object.getOwnPropertyNames = function(obj) {
    if (obj == navigator) {
        return [];
    }
    // console.log('getOwnPropertyNames: ', obj)
    return opn.apply(Object, arguments)
}
...
config = {
    ...
    init: () => {
        ...
        config.Bogus = window['_0x2ae157'];
        config.Signature = window['_0x1ae21a'];
